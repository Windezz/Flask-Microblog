...
@app.route('/', methods=['GET', 'POST'])         # Use decorators to register functions as callbacks of certain events.
@app.route('/index', methods=['GET', 'POST'])    # The decorator creates an association between the URL given as an argument and the function.
...
def index():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('index'))       # It is a standard practice to respond to a POST request generated by a web form submission with a redirect. 
...
@login_required
def explore():
    page = request.args.get('page', 1, type=int)      # page query string argument or a default of 1
